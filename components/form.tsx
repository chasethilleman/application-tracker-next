...
export default function Form({ addApplication }: FormProps) {
    ...
    return (
        <form
            onSubmit={onSubmit}
            className="flex flex-col gap-2 p-4 border border-slate-200 dark:border-neutral-800 rounded-lg col-span-1 bg-white dark:bg-neutral-900 text-left transition-colors h-auto"
        >
            <label
                htmlFor="company"
            ...
            <select
                ...
                onChange={onChange}
                className="appearance-none mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
